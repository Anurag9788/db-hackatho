...
import Helpers.face_train as ft
...
def take_face(name,user):
    directory = './Helpers/'+user
    # directory = user
    cascade_classifier_filename = './Helpers/haarcascade_frontalface_default.xml'
    names_json_filename = './Helpers/names.json'
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            cv2.imwrite(f'./Helpers/{user}/Users-{face_id}-{count}.jpg', gray[y:y+h, x:x+w])
